...
export default function RegisterScreen() {
  ...
  return (
    <KeyboardAvoidingView className="bg-teal-500 h-full w-full">
      ...
      <View className="h-full w-full flex justify-center pt-40">
        ...
        <View className="flex items-center mx-4 space-y-4">
          ...
          <Animated.View entering={FadeInLeft.delay(800)} className="w-full">
          ...
          >
            ...
            <TouchableOpacity onPress={() => navigate.push("Login")}>
              <Text className="text-xl font-bol text-center">Login</Text>
            </TouchableOpacity>
          </Animated.View>
        </View>
      </View>
